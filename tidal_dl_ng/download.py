...
class Download:
    ...
    def metadata_write(
        ...
        m: Metadata = Metadata(
            ...
            artists=name_builder_artist(track, self.settings.data.metadata_artists_name_separator),
            album=track.album.name if track.album else "",
            tracknumber=track.track_num,
            date=release_date,
            isrc=isrc,
            albumartist=name_builder_album_artist(track, self.settings.data.metadata_album_artist_separator),
