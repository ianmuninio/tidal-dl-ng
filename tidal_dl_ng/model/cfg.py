...
class Settings:
    ...
    metadata_artists_name_separator: str = ", "
...
class HelpSettings:
    ...
    metadata_artists_name_separator: str = "Set embedded multiple artists separator"
    metadata_album_artist_separator: str = "Set embedded multiple album artist separator"
